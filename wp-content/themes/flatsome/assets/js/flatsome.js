...
, function(t, e) {
    ...
    if (jQuery(".sticky-shrink .header-wrapper").length) {
        ...
        o = -1 - (l += jQuery("#wpadminbar").height()),
        r = -1 - l
    }
    ...
    a)) {
        ...
        jQuery(window).scroll((function() {
            ...
            t >= e.outerHeight() && (t <= u ? (e.addClass("stuck"),
    ...
    Flatsome.behavior("tabs", {
        attach: function(t) {
            ...
            jQuery(".tabbed-content", t).each((function(t, o) {
                ...
                l.length && (e.toLowerCase().indexOf("comment-") >= 0 || "#comments" === e || "#reviews" === e || "#tab-reviews" === e || n.indexOf("comment-page-") > 0 || n.indexOf("cpage=") > 0) && (l.find("a").click(),
